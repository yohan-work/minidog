...
- **못 본 시간을 정직하게 표시.** minidog이 꺼져 있었거나 컴퓨터가 잠자기 중이던 시간은 장애가 아니라 *측정 못 함*으로 남깁니다. 잠들었다 깨는 장비나 개발용 노트북에서 가짜 알림이 쏟아지지 않습니다.
...
노트북에서는 개발용으로 쓰기 좋습니다. 내 서비스의 트레이스와 로그를 몇 분 만에 볼 수 있습니다. 다만 운영을 감시하는 용도로는 쓰지 마세요. 뚜껑을 닫으면 함께 잠드는 감시자는 새벽 3시에 사이트가 죽은 것을 알려 줄 수 없고, 나중에 "그 시간은 아무도 보고 있지 않았다"고 말해 줄 수 있을 뿐입니다. 다른 필요에는 이런 도구가 더 낫습니다.
